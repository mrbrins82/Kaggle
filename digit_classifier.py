...
def main(train_df, test_df, scoring, cv, random_state):
    ...
    # scale the data to zero mean and unit variance can speed up 
    # neural network
    ...
    # make predictions on test set and write submission file
...
if __name__ == '__main__':
    ...
    random_state = 19790 # for reproducible results
